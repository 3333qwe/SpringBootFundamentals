...
public class LarkUConfig {
    ...
    private LarkUTestDataConfig larkUTestDataConfig = new LarkUTestDataConfig();
    @Bean
    @Profile("development")
    public BaseDAO<Student> studentDAO() {

//        return inMemoryStudentDAO();
        return larkUTestDataConfig.studentDAOWithInitData();
    }


    @Bean(name = "studentDAO")// share same name in dao
    @Profile("production")
